...
func createTokenForAccountId(tenant *store.AtlassianHost, accountId string) (string, error) {
...
func GetAccessToken(tenant *store.AtlassianHost, userAccountId string, scopes []string) (string, error) {
